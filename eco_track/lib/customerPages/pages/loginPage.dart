                      ...
                      onPressed: () async {
                        if (_emailController.text.trim().isNotEmpty &&
                          ...
                          try {
                            ...
                            map['returns'] = _docSnap.get('returns');
                            map['points'] = _docSnap.get('points');

                            MainApp.profileDetialsMap = map;

                            MainApp.userEmail = map['email'];
                            MainApp.userName = map['name'];
                            MainApp.userPassword = map['password'];
