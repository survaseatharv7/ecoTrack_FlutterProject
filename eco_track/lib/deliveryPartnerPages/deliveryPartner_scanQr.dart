...
class DeliverypartnerScanqr extends StatefulWidget {
  final String userType; // Either 'customer' or 'deliveryPartner'

  const DeliverypartnerScanqr({Key? key, required this.userType})
      : super(key: key);
...
class _QRScannerPageState extends State<DeliverypartnerScanqr> {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
              onPressed: () {
                String address = decodedData[1]['custAddress'];
                Navigator.push(
                    context,
                    MaterialPageRoute(
